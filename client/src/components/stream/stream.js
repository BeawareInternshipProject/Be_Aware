...
//     // You need to implement the PDF download functionality here
//     // For simplicity, let's assume we're just opening a static PDF file in a new tab
...
//           <section className={styles.leftSection} style={{backgroundColor:"GrayText"}}>
//             <img
...
//                 <b className={styles.url}>URL 111</b>
//               </button>
//             </div>
//           </section>
